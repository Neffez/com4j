...
public class Com4jgenMojo extends AbstractMojo implements ErrorListener {
     ...
     *
     * <br/>
     * File is the Win32 program that com4j is generating the COM
     ...
     *
     * <br/>
     * LIBID is the Windows identifier of the type library to be
     ...
     * library. <br/>
     * For example, Microsoft Excel 2000 type library has the
     * LIBID of:<br />
     *
     * <code>
    ...
    private void validate() throws MojoExecutionException {
        ...
        if (file != null && !file.exists()) {
            ...
            throw new MojoExecutionException("The native COM target file couldn't be found: " + file);
        }
    }
