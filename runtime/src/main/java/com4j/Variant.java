...
public final class Variant extends Number {
    ...
    public static enum Type implements ComEnum {
         ...
         * MSDN:
         * <p>
         * No value was specified. If an optional argument to an Automation method is left blank, do not pass a VARIANT
         * of type VT_EMPTY.
         ...
         * MSDN:
         * <p>
         * A propagating null value was specified. (This should not be confused with the null pointer.) The null value
         * is used for
         ...
         * MSDN:
         * <p>
         * A currency value was specified. A currency number is stored as 64-bit (8-byte), two's complement integer,
         * scaled by 10,000
         ...
         * MSDN:
         * <p>
         * A value denoting a date and time was specified. Dates are represented as double-precision numbers, where
         * midnight, January 1,
         * 1900 is 2.0, January 2, 1900 is 3.0, and so on. The value is passed in date.
         * </p>
         * <p>
         * This is the same numbering system used by most spreadsheet programs, although some specify incorrectly that
         * February 29, 1900
         * existed, and thus set January 1, 1900 to 1.0. The date can be converted to and from an MS-DOS representation
         * using
         ...
         * MSDN:
         * <p>
         * A pointer to an object was specified. This object is known only to implement IDispatch. The object can
         * be queried as to whether it supports any other desired interface by calling QueryInterface on the object.
         * Objects that do not implement
         * IDispatch should be passed using VT_UNKNOWN.
         * </p>
         */
        VT_DISPATCH(9),
        /**
         ...
         * MSDN:
         * <p>
         * A 16 bit Boolean (True/False) value was specified. A value of 0xFFFF (all bits 1) indicates True; a value of
         * 0 (all bits 0) indicates
         ...
         * VT_I8 is not available in Windows Millennium Edition and earlier versions, or Windows 2000 and earlier
         * versions.
         * </p>
         */
        VT_I8(20),
    ...
    public Variant() {
        ...
        final byte[] b = new byte[16]; // this initializes the array with zeros
     ...
     */
    public Variant(final Type type) {
        this();
        setType(type);
    }
     ...
     */
    public Type getType() {
        final int varType = image.getInt(0) & 0xFFFF;
     ...
     */
    private void changeType(final Type t) {
        if (getType() != t) {
     ...
     */
    /* package */ void makeError(final int hresult) {
        clear();
    ...
    /**
     * Retrieves the current contents of the {@link Variant} and returns an object. The type of the object depends on
     * the type of the
     * {@link Variant}.
     *
    ...
    /**
     * <p>
     * This method is able to set a new value to the underlying VARIANT using native functions. It is able to determine
     * the
    ...
    /**
     * This method is able to retrieve the value of the Variant and return an appropriate Java Object. The type of the
     * object depends on the
     * type of the VARIANT. This means, that this method returns an {@link Integer} object, if the {@link Variant} is of
     * type
     * {@link Type#VT_INT} and it returns an {@link String} object if the {@link Variant} is of the type
     * {@link Type#VT_ARRAY_BSTR}.
     *
    ...
    public <T extends Com4jObject> T object(final Class<T> type) {
        ...
        // @see ComCollection#fetch
        final ComThread t = thread != null ? thread : ComThread.get();
        return t.execute(new Task<T>() {
            @Override
            public T call() {
                final Com4jObject wrapper = convertTo(Com4jObject.class);
                if (null == wrapper) {
                    return null;
                }

                final T ret = wrapper.queryInterface(type);
                wrapper.dispose();
                return ret;
            }
        });
    ...
    static Date toDate(double d) {
        final GregorianCalendar ret = new GregorianCalendar(1899, 11, 30);
        final int days = (int) d;
        d -= days;
        ret.add(Calendar.DATE, days);
        d *= 24;
        final int hours = (int) d;
     ...
     */
    static double fromDate(final Date dt) {
