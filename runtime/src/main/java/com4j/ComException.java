...
public class ComException extends RuntimeException {
     ...
     */
    public ComException(final String msg, final int hresult, final String fileName, final int line) {
     ...
     * @param line the line in the file where the error occurred
     */
    public ComException(final String msg, final String fileName, final int line) {
        super(msg);
        this.hresult = -1;
        this.fileName = fileName;
        this.line = line;
     ...
     * @param hresult the HRESULT value of the COM error
     */
    public ComException(final String msg, final int hresult) {
     ...
     */
    public ComException(final ComException cause) {
     ...
     */
    /* package */ void setErrorInfo(final ErrorInfo errorInfo) {
     ...
     * @return
     */
    private static String cutEOL(final String s) {
        if (s == null) {
    ...
    public String getMessage() {
        ...
        final String s = Native.getErrorMessage(hresult);
        if (s != null) {
