...
public class ROT implements Iterable<Com4jObject> {
    ...
    private static class ROTIterator implements Iterator<Com4jObject> {
        ...
        /**
         * The next object of the running object table. To be able to provide the functionality of the hasNext method,
         * we always need to prefetch one object ahead.
         */
        ...
        public Com4jObject next() {
            if (rotPointer != 0 && enumMonikerPointer != 0 && nextObject != null) {
                final Com4jObject current = nextObject;
                fetchObject();
                return current;
            } else {
                return null;
        ...
        /**
         * Removing elements form the ROT through an Iterator does not make sense (we cannot unregister third party
         * objects).
         */
        @Override
        public void remove() {
        ...
        private class GetNextRunningObjectTask extends Task<Com4jObject> {
            ...
            public Com4jObject call() {
                final long pointer = Native.getNextRunningObject(rotPointer, enumMonikerPointer);
                if (pointer == 0) {
