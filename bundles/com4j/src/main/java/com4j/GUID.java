...
public final class GUID {
    ...
    public GUID(String str) {
        ...
        v[1] = parse(str, 20, 2) | parse(str, 22, 2) << 8 | parse(str, 25, 2) << 16 | parse(str, 27, 2) << 24
                | parse(str, 29, 2) << 32 | parse(str, 31, 2) << 40 | parse(str, 33, 2) << 48 | parse(str, 35, 2) << 56;
    }
    ...
    private void toHex(final StringBuffer buf, final long n, final int len) {
